      ...
      <div className="card mb-4">
        <div className="card-body">
          <div className="row g-3">
            <div className="col-md-3">
              <label htmlFor="period-filter" className="form-label">
                Period
              </label>
              <select
                id="period-filter"
                      ...
                      {editingId === transaction.id ? (
                        ...
                        <>
                          ...
                          <td>
                            ...
                            >
                              {(transaction.description || transaction.note || "").length > 30
                                ? (transaction.description || transaction.note || "").substring(
                                    0,
                                    30
                                  ) + "..."
                          ...
                          <td>
                            ...
                            >
                              <i
                                className={`fas ${transaction.type === "income" ? "fa-arrow-up" : "fa-arrow-down"} me-1`}
                              ></i>
                              {transaction.type}
                            </span>
                          </td>
                          <td
                            className={`text-end fw-bold ${transaction.type === "income" ? "text-success" : "text-danger"}`}
                          >
