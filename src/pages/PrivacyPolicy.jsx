        ...
        <div className="col-lg-8">
          ...
          <div className="card">
            <div className="card-body">
              <p className="lead">
                At MCC Finance Planner, we take your privacy seriously. This policy explains how we collect, use, and protect your personal information.
              </p>
              
              <h3>Information We Collect</h3>
              <ul>
                <li><strong>Account Information:</strong> Email address and encrypted password for authentication</li>
                <li><strong>Financial Data:</strong> Transaction records, categories, and budgets you create</li>
                <li><strong>Usage Data:</strong> How you interact with our application for improving user experience</li>
              </ul>
              ...
              <p>
                ...
                <a href="https://github.com/michael-mpj/MCC-Finance-Planner/issues"> GitHub issues page</a>.
              </p>
